...
const faqs = [
  ...
  },
  {
    ...
    a: "Click Manage Subscription in the top right of the site, enter your email, and you'll go straight to your billing page. Cancel in one click — no retention hoops. Your access continues until the end of the period you already paid for."
  },
]
      ...
      <header style={{ padding: '1rem 2rem', borderBottom: '1px solid var(--border)', display: 'flex', alignItems: 'center', justifyContent: 'space-between', background: 'var(--surface)' }}>
        <div style={{ display: 'flex', alignItems: 'center' }}>
          <Link href="/" style={{ display: 'flex', alignItems: 'center', gap: '10px', textDecoration: 'none' }}>
            <img src="/jobsuncleaiblack.png" alt="JobsUncle.ai" style={{ height: '36px', width: 'auto' }} onError={e => { e.target.src='/favicon-32x32.png' }} />
          </Link>
          ...
          <a href="/pricing" className="header-nav-link" style={{ color: 'var(--text-soft)', textDecoration: 'none', fontSize: '0.8rem', fontWeight: 600, marginLeft: '1.25rem' }}>Pricing</a>
          <a href="mailto:jobsuncleai@gmail.com" className="header-nav-link" style={{ color: 'var(--text-soft)', textDecoration: 'none', fontSize: '0.8rem', fontWeight: 600, marginLeft: '1.25rem' }}>Contact</a>
        </div>

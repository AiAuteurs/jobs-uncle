...
import HomepageDemoPanel from '../components/HomepageDemoPanel'
...
// ─── CLIENT-SIDE ATS SCORER — restored to original logic that scored 90% ──────
function clientScoreATS(resumeText, jobDescription) {
  ...
  const TECH_SIGNALS = [
    ...
    'analytics','strategy','stakeholder','curriculum','instructional',
    'assessment','outcomes','metrics','reporting',
    ...
    'agile','scrum','product','research','data',
    'accounting','budget','forecasting',
    'marketing','campaigns','seo','branding','copywriting',
    ...
    'content','design','workflow','standards',
    ...
    try {
      const payload = {
        ...
        fileBaseName: results.fileBaseName
          ? `${results.fileBaseName}_${
              type === 'resume'
                ? results.dualVersion
                  ? activeResume === 'a' ? 'Resume_Leadership' : 'Resume_Technical'
                  : activeVersion === 'v2' ? 'Resume_Fixed' : 'Resume'
                : type === 'cover'
                ? activeVersion === 'v2' ? 'Cover_Letter_Fixed' : 'Cover_Letter'
                : 'Full_Package'
            }`
          : type,
      }
            ...
            {isPlusUser && (
              <div style={{
                ...
                <div style={{ textAlign: 'center' }}>
                  ...
                  <p style={{ fontFamily: 'Inter', fontSize: '0.78rem', color: '#ffffff', margin: 0, lineHeight: 1.6, textAlign: 'center' }}>One generation, two complete resumes —<br />one framed around leadership, one around execution.<br />Send whichever fits the role.<br />Built for senior careers that can go in more than one direction.</p>
                </div>
                <button
          ...
          <>
            <div className="results">
              ...
              <div style={{
                ...
                <strong style={{ color: '#111111' }}>Important: </strong>
                ...
                <div className="format-cards">
                  ...
                  <div className="format-card">
                    ...
                    <div className="format-btns">
                      ...
                      <button className={`format-btn${activeDownloadBtn === 'txt-cover' ? ' format-btn-active' : ''}`} onClick={() => { setActiveDownloadBtn('txt-cover'); downloadTxt(activeCoverForDownload, activeVersion === 'v2' ? 'Cover_Letter_Fixed' : 'Cover_Letter') }}>
                        Cover Letter
                      </button>
                    </div>
                  </div>
                  ...
                  <div className="format-card">
                    ...
                    <div className="format-btns">
                      ...
                      <button className={`format-btn${activeDownloadBtn === 'pdf-cover' ? ' format-btn-active' : ''}`} onClick={() => { setActiveDownloadBtn('pdf-cover'); downloadPdf(activeCoverForDownload, activeVersion === 'v2' ? 'Cover_Letter_Fixed' : 'Cover_Letter') }}>
                        Cover Letter
                      </button>
                    </div>
                  </div>
            ...
            {!isPlusUser && (
              <div style={{
                ...
                <div>
                  <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '8px', marginBottom: '6px' }}>
                    <span style={{ fontFamily: 'Georgia, serif', fontSize: '1rem', fontWeight: 400, color: '#ffffff' }}>ATS Cheat Sheet + Dual Versions</span>
                    <span style={{ background: '#6366f1', color: 'white', fontSize: '0.55rem', fontWeight: 700, letterSpacing: '0.1em', padding: '2px 8px', borderRadius: '20px', textTransform: 'uppercase' }}>Pro+</span>
                  </div>
                ...
                <button
                  onClick={() => setShowPlusPaywall(true)}
                  style={{ flexShrink: 0, padding: '10px 28px', background: '#ffffff', color: '#000000', border: 'none', borderRadius: '50px', fontSize: '0.82rem', fontWeight: 700, cursor: 'pointer', letterSpacing: '0.01em' }}
                >
                  Upgrade to Pro+ →
                </button>
              </div>
